                            ...
                            <div className="card rounded-2 address mb-2 border-0">
                                <div className="card-body d-flex align-items-center justify-content-between">
                                    <div className="left">
                                        ...
                                        <br />
                                        <span className="text-muted fw-bold">*Delivery Available in Pan India Only</span>
                                        <br />
                                    </div>
                                    <div className="right">
                                    ...
                                    <div className="card cart-item mb-3" key={index}>
                                        <div className="card-body">
                                            <div className="row g-3">
                                                ...
                                                <div className="col-lg-9 col-sm-9 col-8 chkut_pge">
...
{/*                                                            
                                                            ...
                                                            {/* <div className="qty">
                                                    <select className="form-select form-select-sm rounded-2" aria-label="Default select example">
                                                        <option selected={item.quantity}>{item.quantity}</option>
