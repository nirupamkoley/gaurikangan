...
<section className="fluid-block collections">
        <div className="container">
                        ...
                        <div className="col-lg-3">
                            <div className="card border-0 rounded-0">
                                <a href="product-listing.html" className="card-img">
                                    ...
                                    <img src="images/t-1.jpg" alt="" className="img-fluid square-img" />
                                </a>
                        ...
                        <div className="col-lg-3">
                            <div className="card border-0 rounded-0">
                                <a href="product-listing.html" className="card-img">
                                    ...
                                    <img src="images/t-2.jpg" alt="" className="img-fluid square-img" />
                                </a>
                                <div className="card-body p-0 py-4">
                                    <div className="info">
                                        <h3 className="fs-4">Imitation Ring</h3>
                        ...
                        <div className="col-lg-3">
                            <div className="card border-0 rounded-0">
                                <a href="product-listing.html" className="card-img">
                                    ...
                                    <img src="images/t-4.jpg" alt="" className="img-fluid square-img" />
                                </a>
                                <div className="card-body p-0 py-4">
                                    <div className="info">
                                        <h3 className="fs-4">Imitation Ring</h3>
                        ...
                        <div className="col-lg-3">
                            <div className="card border-0 rounded-0">
                                <a href="product-listing.html" className="card-img">
                                    ...
                                    <img src="images/t-14.jpg" alt="" className="img-fluid square-img" />
                                </a>
                                <div className="card-body p-0 py-4">
                                    <div className="info">
                                        <h3 className="fs-4">Imitation Ring</h3>
                        ...
                        <div className="col-lg-3">
                            <div className="card border-0 rounded-0">
                                <a href="product-listing.html" className="card-img">
                                    ...
                                    <img src="images/t-15.jpg" alt="" className="img-fluid square-img" />
                                </a>
                                <div className="card-body p-0 py-4">
                                    <div className="info">
                                        <h3 className="fs-4">Imitation Ring</h3>
                        ...
                        <div className="col-lg-3">
                            <div className="card border-0 rounded-0">
                                <a href="product-listing.html" className="card-img">
                                    ...
                                    <img src="images/t-16.jpg" alt="" className="img-fluid square-img" />
                                </a>
                                <div className="card-body p-0 py-4">
                                    <div className="info">
                                        <h3 className="fs-4">Imitation Ring</h3>
                        ...
                        <div className="col-lg-3">
                            <div className="card border-0 rounded-0">
                                <a href="product-listing.html" className="card-img">
                                    ...
                                    <img src="images/t-17.jpg" alt="" className="img-fluid square-img" />
                                </a>
                                <div className="card-body p-0 py-4">
                                    <div className="info">
                                        <h3 className="fs-4">Imitation Ring</h3>
            ...
            <div className="text-center mt-5">
                <a href="product-listing.html" className="btn btn-primary-light rounded-5">View All</a>
            </div>
        </div>
    </section>
            ...
            <Slider className="catagory-slider-2"  {...getSliderSettings(5, 5, 0)}>
                <div className="card border-0 rounded-4 overflow-hidden">
                    <a href="product-listing.html" className="card-img">
                        ...
                        <img src="images/t-9.jpg" alt="" className="img-fluid" />
                    </a>
                </div>
                <div className="card border-0 rounded-4 overflow-hidden">
                    <a href="product-listing.html" className="card-img">
                        <div className="title">Earrings</div>
                        <img src="images/t-10.jpg" alt="" className="img-fluid" />
                    </a>
                </div>
                <div className="card border-0 rounded-4 overflow-hidden">
                    <a href="product-listing.html" className="card-img">
                        <div className="title">Necklaces</div>
                        <img src="images/t-11.jpg" alt="" className="img-fluid" />
                    </a>
                </div>
                <div className="card border-0 rounded-4 overflow-hidden">
                    <a href="product-listing.html" className="card-img">
                        <div className="title">Bracelates</div>
                        <img src="images/t-12.jpg" alt="" className="img-fluid" />
                    </a>
                </div>
                <div className="card border-0 rounded-4 overflow-hidden">
                    <a href="product-listing.html" className="card-img">
                        <div className="title">Bracelates</div>
                        <img src="images/t-13.jpg" alt="" className="img-fluid" />
                    </a>
                </div>
                <div className="card border-0 rounded-4 overflow-hidden">
                    <a href="product-listing.html" className="card-img">
        ...
        <div className="container">
            <div className="row g-5">
                <div className="col-lg-6">
                    <a href="#" className="d-block rounded-4 overflow-hidden"><img src="images/offer-3.jpg" className="img-fluid" /></a>
                </div>
                <div className="col-lg-6">
                    <a href="#" className="d-block rounded-4 overflow-hidden"><img src="images/offer-4.jpg" className="img-fluid" /></a>
                </div>
            </div>
        </div>
    </section>
...
<section className="fluid-block collections pt-2">
        <div className="container">
                ...
                <div className="col-lg-3">
                    <div className="card border-0 rounded-0">
                        <a href="product-listing.html" className="card-img">
                            ...
                            <img src="images/p-1.jpg" alt="" className="img-fluid square-img" />
                        </a>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <h3 className="fs-4">Imitation Ring</h3>
                ...
                <div className="col-lg-3">
                    <div className="card border-0 rounded-0">
                        <a href="product-listing.html" className="card-img">
                            ...
                            <img src="images/p-2.jpg" alt="" className="img-fluid square-img" />
                        </a>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <h3 className="fs-4">Imitation Ring</h3>
                ...
                <div className="col-lg-3">
                    <div className="card border-0 rounded-0">
                        <a href="product-listing.html" className="card-img">
                            ...
                            <img src="images/p-3.jpg" alt="" className="img-fluid square-img" />
                        </a>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <h3 className="fs-4">Imitation Ring</h3>
                ...
                <div className="col-lg-3">
                    <div className="card border-0 rounded-0">
                        <a href="product-listing.html" className="card-img">
                            ...
                            <img src="images/p-4.jpg" alt="" className="img-fluid square-img" />
                        </a>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <h3 className="fs-4">Imitation Ring</h3>
                ...
                <div className="col-lg-3">
                    <div className="card border-0 rounded-0">
                        <a href="product-listing.html" className="card-img">
                            ...
                            <img src="images/p-5.jpg" alt="" className="img-fluid square-img" />
                        </a>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <h3 className="fs-4">Imitation Ring</h3>
                ...
                <div className="col-lg-3">
                    <div className="card border-0 rounded-0">
                        <a href="product-listing.html" className="card-img">
                            ...
                            <img src="images/p-6.jpg" alt="" className="img-fluid square-img" />
                        </a>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <h3 className="fs-4">Imitation Ring</h3>
                ...
                <div className="col-lg-3">
                    <div className="card border-0 rounded-0">
                        <a href="product-listing.html" className="card-img">
                            ...
                            <img src="images/p-7.jpg" alt="" className="img-fluid square-img" />
                        </a>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <h3 className="fs-4">Imitation Ring</h3>
                ...
                <div className="col-lg-3">
                    <div className="card border-0 rounded-0">
                        <a href="product-listing.html" className="card-img">
                            ...
                            <img src="images/p-8.jpg" alt="" className="img-fluid square-img" />
                        </a>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <h3 className="fs-4">Imitation Ring</h3>
            ...
            <div className="text-center mt-5">
                <a href="product-listing.html" className="btn btn-primary-light">View All</a>
            </div>
        </div>
    </section>
            ...
            <Slider className="catagory-slider"  {...getSliderSettings(4,4,0)}>
                ...
                <div className="card border-0 rounded-0">
                    <a href="product-listing.html" className="card-img">
                        ...
                        <img src="images/t-15.jpg" alt="" className="img-fluid" />
                    </a>
                    <div className="card-body p-0 py-4">
                        <div className="info">
                            <h3 className="fs-4">Necklace Collection</h3>
                ...
                <div className="card border-0 rounded-0">
                    <a href="product-listing.html" className="card-img">
                        ...
                        <img src="images/t-17.jpg" alt="" className="img-fluid" />
                    </a>
                    <div className="card-body p-0 py-4">
                        <div className="info">
                            <h3 className="fs-4">Necklace Collection</h3>
            ...
            <Slider className="catagory-slider"   {...getSliderSettings(4, 4, 0)}>
                ...
                <div className="card border-0 rounded-0">
                    <a href="product-listing.html" className="card-img">
                        ...
                        <img src="images/t-5.jpg" alt="" className="img-fluid square-img" />
                    </a>
                    <div className="card-body p-0 py-4">
                        <div className="info">
                            <h3 className="fs-4">Earrings Colections</h3>
                ...
                <div className="card border-0 rounded-0">
                    <a href="product-listing.html" className="card-img">
                        ...
                        <img src="images/t-6.jpg" alt="" className="img-fluid square-img" />
                    </a>
                    <div className="card-body p-0 py-4">
                        <div className="info">
                            <h3 className="fs-4">Necklace Collection</h3>
                ...
                <div className="card border-0 rounded-0">
                    <a href="product-listing.html" className="card-img">
                        ...
                        <img src="images/t-7.jpg" alt="" className="img-fluid square-img" />
                    </a>
                    <div className="card-body p-0 py-4">
                        <div className="info">
                            <h3 className="fs-4">Necklace Collection</h3>
                ...
                <div className="card border-0 rounded-0">
                    <a href="product-listing.html" className="card-img">
                        ...
                        <img src="images/t-8.jpg" alt="" className="img-fluid square-img" />
                    </a>
                    <div className="card-body p-0 py-4">
                        <div className="info">
                            <h3 className="fs-4">Necklace Collection</h3>
...
<section className="fluid-block offer-block">
        <div className="container">
            <div className="row g-5">
                <div className="col-lg-6">
                    <a href="#" className="d-block rounded-4 overflow-hidden shadow-lg"><img src="images/offer-1.jpg" className="img-fluid" /></a>
                </div>
                <div className="col-lg-6">
                    <a href="#" className="d-block rounded-4 overflow-hidden shadow-lg"><img src="images/offer-2.jpg" className="img-fluid" /></a>
                </div>
            </div>
        </div>
    </section>
...
<section className="fluid-block blog bg-light">
        <div className="container">
            <div className="title-div text-center">
                <h2 className="text-uppercase mb-0 fw-bold">Latest Blog Posts</h2>
                <small>latest blog posts</small>
            </div>
            <div className="row g-4 blog-carousel">
                <div className="col-lg-3">
                    <a href="blog.html" className="card border-0 rounded-0">
                        <div className="card-img">
                            <img src="images/b-1.jpg" alt="" className="img-fluid rounded-4" />
                        </div>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                ...
                <div className="col-lg-3">
                    <a href="blog.html" className="card border-0 rounded-0">
                        <div className="card-img">
                            <img src="images/b-2.jpg" alt="" className="img-fluid rounded-4" />
                        </div>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
                ...
                <div className="col-lg-3">
                    <a href="blog.html" className="card border-0 rounded-0">
                        <div className="card-img">
                            <img src="images/b-3.jpg" alt="" className="img-fluid rounded-4" />
                        </div>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
                ...
                <div className="col-lg-3">
                    <a href="blog.html" className="card border-0 rounded-0">
                        <div className="card-img">
                            <img src="images/b-4.jpg" alt="" className="img-fluid rounded-4" />
                        </div>
                        <div className="card-body p-0 py-4">
                            <div className="info">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
            ...
            <div className="text-center mt-4">
                <a href="product-listing.html" className="btn btn-secondary">View All</a>
            </div>
        </div>
    </section>
