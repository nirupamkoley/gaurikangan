            ...
            <section className="fluid-block contact border-bottom">
                <div className="container col-lg-7">
                    <div className="title-div text-center">
                        ...
                        <small className="fs-5 text-muted">Contact Gouri Kangan</small>
                    </div>
                            ...
                            <div className="card rounded-0">
                                <div className="card-body p-4">
                                    ...
                                    <div className="d-flex align-items-center gap-3 mb-4 border-bottom pb-4">
                                        ...
                                        <div className="right">
                                            <span className="fs-5"><a href="mailto:info@gmail.com">info@gmail.com</a></span>
                                        </div>
                                    </div>
                                    <div className="d-flex align-items-center gap-3">
                                        ...
                                        <div className="right">
                                            <span className="fs-5"><a href="tel:123456890">+91 123456890</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
